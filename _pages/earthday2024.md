...
<figure style="max-width: 540px" class="align-center">
  <img src="/assets/images/posters/earthday2024.3.png" alt="Earth Day Clean Up Contest">
...
1. **Join the Cleanup** - grab a bag, clean, and tag! Jurors will select the photos that
   best match their categories (for example, “Strangest Find”)
1. **Host a Hub** - A hub is a place where volunteers can pick up trash bags and any other
   promotional items you would like to offer. For example, any registered team will be
   able to pick up bags & gloves at The Tool Library. Need guidance? Please reach out to us!
   Just fill out our [HOST A HUB FORM](
   https://docs.google.com/forms/d/1VbVambC_aFPLcMHYdSVDap_flOKUx-jc63K637YWBh0/viewform).
1. **Donate a Prize** - donate art, an item, a service, an experience, a gift certificate,
   ...
   https://docs.google.com/forms/d/e/1FAIpQLSeoV0qPMR6sgc1F4FYJnLMudpWR3VofFqXqh9Z3cJ5exIEKFw/viewform
   ){: .btn .btn--success} 
